...
import coverArtMyHeart from "@/assets/cover-art-my-heart.png"
import coverArtSayLess from "@/assets/cover-art-say-less.png"

const artists = [
  { name: "Joy Lewis", genre: "R&B", imageUrl: coverArtBetter, fitMode: "contain" as const },
  { name: "Joy Lewis", genre: "Pop", imageUrl: coverArtMyHeart, fitMode: "contain" as const },
  { name: "Say Less", genre: "Hip Hop", imageUrl: coverArtSayLess, fitMode: "contain" as const },
  ...
  { name: "Eden Reign", genre: "Christian", imageUrl: coverArtGraceAbove, fitMode: "contain" as const },
