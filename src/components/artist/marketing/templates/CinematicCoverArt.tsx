  ...
  return (
    ...
    >
      ...
      <div className="absolute pointer-events-none" style={{
        ...
        background: "radial-gradient(ellipse at center, hsla(210, 70%, 30%, 0.22) 0%, hsla(215, 60%, 25%, 0.08) 50%, transparent 75%)",
        filter: "blur(50px)",
      }} />
      <div className="absolute pointer-events-none" style={{
        top: "35%", right: "-8%", width: "50%", height: "45%",
        background: "radial-gradient(ellipse at center, hsla(220, 65%, 28%, 0.20) 0%, hsla(210, 55%, 22%, 0.06) 55%, transparent 80%)",
        filter: "blur(55px)",
      }} />
      <div className="absolute pointer-events-none" style={{
        bottom: "10%", left: "20%", width: "60%", height: "35%",
        background: "radial-gradient(ellipse at center, hsla(205, 60%, 25%, 0.18) 0%, transparent 70%)",
        filter: "blur(45px)",
      }} />
      ...
      <div className="relative z-10 mt-[6px] flex flex-col items-center gap-[6px]">
        ...
        <span className="uppercase font-extrabold px-8 py-2" style={{
          ...
          animation: "marketing-glow-cta-blue 3s ease-in-out infinite",
        }}>
          {ctaLine}
        </span>
      </div>
